...
def cadastroContatos():
  try:
    ...
    if flask.request.method == "POST":  
      ...
      contatos[flask.request.form['email']] = {'nome': flask.request.form['nome'], 'telefone': flask.request.form['telefone'], 'assunto': flask.request.form['contato-assunto'],'mensagem': flask.request.form['contato-mensagem'],'opcao-resposta': flask.request.form['opcao-resposta']}
